...
![Localización del área de estudio, estación meteorológica y buffer inicial de 300 m. Esta unidad espacial permitió relacionar la señal puntual de estación con variables espectrales derivadas de Sentinel-2.](data/article_figures/maps_qgis/exports_png/fig_map01_localizacion_area_estudio.png){#fig-localizacion width=90%}
...
## Disponibilidad de datos, código y reproducibilidad
